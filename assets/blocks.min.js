...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.CaxtonLayoutBlocksSetup=void 0;var _fields=require("./fields.es6"),_grid=require("./grid.es6"),_section=require("./section.es6"),_flex=require("./flex.es6"),_tpl=require("./tpl.es6");function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}var CaxtonLayoutBlocksSetup=function(t,e){var o=e.element,n=caxtonWPEditor.InnerBlocks,r=o.createElement;_fields.gridFields["Mobile layout"].render=_grid.responsiveLayoutPicker,_fields.gridFields["Tablet layout"].render=_grid.responsiveLayoutPicker,CaxtonBlock({id:"caxton/grid",title:"Caxton Layouts",icon:"screenoptions",category:"caxton",fields:_fields.gridFields,attributes:{tpl:{type:"string"}},edit:function(t,e){return(0,_grid.gridRender)(t,e,(0,_grid.gridContent)(t,e))},save:function(t,e){return(0,_grid.gridRender)(t,e,r(n.Content,{key:"innerblockscontent"}))}}),CaxtonBlock({id:"caxton/section",title:"Caxton section",icon:"screenoptions",parent:["caxton/grid"],category:"caxton",attributes:{tpl:{type:"string"}},fields:_fields.sectionFields,edit:function(t,e){var o=[];t.attributes.tpl&&0===t.attributes.tpl.indexOf("[")&&t.attributes.tpl.indexOf("]")>0&&(o=JSON.parse(t.attributes.tpl));var i=r(n,{template:o,templateLock:!1,key:"innerblocks"});return(0,_section.sectionRender)(t,e,i)},save:function(t,e){return(0,_section.sectionRender)(t,e,[r(n.Content,{key:"innerblockscontent"})])},wrapperProps:function(t,e){return t["data-caxton-section"]=e["Grid area"],t.style={},t.style.gridArea=e["Grid area"],t}}),CaxtonBlock({id:"caxton/horizontal",title:"Horizontal blocks (deprecated)",icon:"text",category:"caxton",fields:_fields.flexFields,edit:function(t,e){return(0,_flex.flexRender)(t,e,[r(n,{key:"innerblocks",templateLock:!1})])},save:function(t,e){return(0,_flex.flexRender)(t,e,[r(n.Content,{key:"innerblockscontent"})])}}),CaxtonBlock({id:"caxton/flex",title:"Flex blocks (beta)",icon:"text",category:"caxton",fields:_fields.flexFields,edit:function(t,e){return(0,_flex.flexRender)(t,e,[r(n,{key:"innerblocks",templateLock:!1,renderAppender:function(){return r(n.ButtonBlockAppender)}})])},save:function(t,e){return(0,_flex.flexRender)(t,e,[r(n.Content,{key:"innerblockscontent"})])},transforms:{from:[{type:"caxton/horizontal"}]}}),window.CaxtonLayoutOptionsBlock=function(t,e){t.id&&t.title||console.error("Function CaxtonLayoutOptionsBlock requires `id` and `title` properties on first parameter object."),t.debug&&(_fields.tplFields.tpl={type:"textarea",section:"Layout"});var o={icon:"screenoptions",category:"caxton",fields:_fields.tplFields,attributes:{tpl:{type:"string"}},chooseLayoutTitle:"Please choose a layout",optionsRenderer:function(t,o){for(var n=function(e){var o=jQuery(e.target).closest(".caxton-layout-option").data("props");"string"==typeof o&&(o=JSON.parse(o)),"object"===_typeof(o.tpl)&&(o.tpl=JSON.stringify(o.tpl)),t.setAttributes(o)},i=[],l=0;l<e.length;l++){var s=e[l];i.push(r("div",{className:"caxton-layout-option",key:"option-"+l,"data-props":JSON.stringify(s.props),onClick:n},r("img",{src:s.img}),r("h5",{},s.title)))}return r("div",{},[r("h4",{key:"heading"},"Select a layout"),r("div",{key:"options",className:"caxton-layout-options"},i)])},edit:function(t,e){return(0,_tpl.tplRender)(t,e,(0,_tpl.tplContent)(t,e,o.optionsRenderer))},save:function(t,e){return(0,_tpl.tplRender)(t,e,r(n.Content,{key:"innerblockscontent"}))}};for(var i in t)t.hasOwnProperty(i)&&(o[i]=t[i]);CaxtonBlock(o)}};exports.CaxtonLayoutBlocksSetup=CaxtonLayoutBlocksSetup;
