...
"use strict";function tplRender(t,e,n){var r,a,l,d,i,o=wp.element.createElement,s="relative ",p="relative "+e.block.id.replace("/","-"),g=e.attrs["Inner Padding left/right tablet"],u=e.attrs["Inner Padding left/right mobile"];return r=e.attrs["Inner Padding unit"],a=e.attrs["Inner Padding top"],l=e.attrs["Inner Padding left"],d=e.attrs["Inner Padding bottom"],i=e.attrs["Inner Padding right"],"px"===r&&(a*=5,l*=5,d*=5,i*=5),a=a?a+r:0,l=l?l+r:0,d=d?d+r:0,i=i?i+r:0,e.attrs.Layout&&(s+=" "+e.attrs.Layout),e.attrs["Column gap"]&&(p+=" "+e.attrs["Column gap"]),e.attrs["Full height"]&&(p+=" "+e.attrs["Full height"]),o("div",{className:s,key:"caxton-grid-block"},o("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML("{{Background}}")}),o("div",{className:p,style:{paddingTop:a,paddingLeft:l,paddingBottom:d,paddingRight:i,gridTemplateColumns:"repeat(12, 1fr)"},"data-tablet-css":"padding-left:"+u+"em;padding-right:"+u+"em;","data-mobile-css":"padding-left:"+g+"em;padding-right:"+g+"em;",key:"block"},n))}function tplContent(t,e,n){var r=wp.element.createElement;if(t.attributes.tpl&&0===t.attributes.tpl.indexOf("[")&&t.attributes.tpl.indexOf("]")>0){var a=JSON.parse(t.attributes.tpl);return r(caxtonWPEditor.InnerBlocks,{template:a,templateLock:!1,key:"innerblocks",renderAppender:function(){return r(caxtonWPEditor.InnerBlocks.ButtonBlockAppender)}})}return n(t,e)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.tplContent=tplContent,exports.tplRender=tplRender;
