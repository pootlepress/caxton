 ...
 * @version 1.0.0
 */
(function ($, blocks, el, i18n, _ref) {
	var SelectControl = _ref.SelectControl,
	    TextControl = _ref.TextControl,
	    ToggleControl = _ref.ToggleControl,
	...
	CaxtonBlock({
		...
		fields: {
			...
			'Buttons style': {
				type: 'radio',
				options: [{ value: 'br0', label: 'Boxed corners' }, { value: 'br3', label: "Rounded corners" }, { value: 'ph3 br-pill', label: 'Pill' }],
				default: 'br2'
			}
		}
	});
	...
	CaxtonBlock({
		...
		category: 'caxton',
		tpl: '<{{Element Tag}} class="{{Alignment}}" ' + 'style="{{Letter Spacing}}{{Margin top}}{{Margin bottom}}{{Inner Padding}}{{Left/right Inner Padding}}{{Weight}}{{Font}}{{Text color}}{{Background color}}{{Font size}}{{Line height}}{{Text Glow/Shadow}}" ' + 'data-mobile-css="{{Font size mobile}}" ' + 'data-tablet-css="{{Font size tablet}}" ' + 'data-desktop-css="{{Font size}}">' + '<span class="{{Lines as wide as content}}">{{Overline}}{{Text}}{{Underline}}</span>' + '</{{Element Tag}}>',
		transforms: {
			from: [{
				type: 'block',
		...
		fields: {
			...
			'Element Tag': {
				type: 'radio',
				section: 'Layout',
				options: [{ value: 'p', label: 'Paragraph' }, { value: 'h1', label: 'Heading 1' }, { value: 'h2', label: 'Heading 2' }, { value: 'h3', label: 'Heading 3' }, { value: 'h4', label: 'Heading 4' }, { value: 'h5', label: 'Heading 5' }, { value: 'h6', label: 'Heading 6' }, { value: 'div', label: 'Normal div' }],
				default: 'p'
			...
			'Text Glow/Shadow': {
				type: 'select',
				options: [{ value: '', label: 'No shadow/glow' }, { value: '255,255,255', label: 'Glow' }, { value: '0,0,0', label: 'Shadow' }],
				section: 'Glow/Shadow',
				tpl: 'text-shadow:{{Shadow position}} {{Shadow Blur}} rgba(%s,{{Shadow Strength}});'
			},
			'Shadow position': {
				type: 'select',
				options: [{ value: 'calc( -2px + -.05em ) calc( 2px + .03em )', label: 'Far Left' }, { value: 'calc( -1px + -.03em ) calc( 1px + .01em )', label: 'Left' }, { value: '0 0', label: 'Center' }, { value: 'calc( 1px + .03em ) calc( 1px + .01em )', label: 'Right' }, { value: 'calc( 2px + .05em ) calc( 2px + .03em )', label: 'Far Right' }],
				default: '0 0',
				section: 'Glow/Shadow'
			},
			'Shadow Blur': {
	...
	CaxtonBlock({
		...
		fields: {
			...
			'Text Glow/Shadow': {
				type: 'select',
				options: [{ value: '', label: 'None' }, { value: ' text-glow', label: 'Glow' }, { value: ' text-shadow', label: 'Shadow' }],
	...
	CaxtonBlock({
		...
		fields: {
			...
			'Glow/Shadow': {
				type: 'select',
				options: [{ value: '', label: 'None' }, { value: ' glow', label: 'Glow' }, { value: ' shadow', label: 'Shadow' }],
	...
	CaxtonBlock({
		...
		icon: 'slides',
		category: 'caxton',
		tpl: '<div class="caxton-slider caxton-slider-pending-setup {{Alignment}}{{BlockAlignment}}" style="{{Text color}}{{Font size}}{{Text Glow/Shadow}};" ' + 'data-mobile-css="{{Font size mobile}}" ' + 'data-tablet-css="{{Font size tablet}}" ' + 'data-desktop-css="{{Font size}}">' + '<ul class="slides">' + '{{Slide 1 image}}' + '{{Slide 2 image}}' + '{{Slide 3 image}}' + '{{Slide 4 image}}' + '{{Slide 5 image}}' + '</ul></div>',
		toolbars: {
			Alignment: 'AlignmentToolbar',
			BlockAlignment: 'BlockAlignToolbar'
		},
		...
		fields: {
			...
			'Slide 1 image': {
				type: 'image',
				tpl: '<li style="background-image: url(\'%s\')">' + '<div class="flex-caption  header-slide-text">' + '{{Slide 1 title}}{{Slide 1 text}}{{Slide 1 button text}}' + '</div>' + '</li>',
				section: 'Slide 1'
			},
			'Slide 1 title': {
				type: 'text',
			...
			'Slide 2 image': {
				type: 'image',
				tpl: '<li style="background-image: url(\'%s\')">' + '<div class="flex-caption  header-slide-text">' + '{{Slide 2 title}}{{Slide 2 text}}{{Slide 2 button text}}' + '</div>' + '</li>',
				section: 'Slide 2'
			},
			'Slide 2 title': {
				type: 'text',
			...
			'Slide 3 image': {
				type: 'image',
				tpl: '<li style="background-image: url(\'%s\')">' + '<div class="flex-caption  header-slide-text">' + '{{Slide 3 title}}{{Slide 3 text}}{{Slide 3 button text}}' + '</div>' + '</li>',
				section: 'Slide 3'
			},
			'Slide 3 title': {
				type: 'text',
			...
			'Slide 4 image': {
				type: 'image',
				tpl: '<li style="background-image: url(\'%s\')">' + '<div class="flex-caption  header-slide-text">' + '{{Slide 4 title}}{{Slide 4 text}}{{Slide 4 button text}}' + '</div>' + '</li>',
				section: 'Slide 4'
			},
			'Slide 4 title': {
				type: 'text',
			...
			'Slide 5 image': {
				type: 'image',
				tpl: '<li style="background-image: url(\'%s\')">' + '<div class="flex-caption  header-slide-text">' + '{{Slide 5 title}}{{Slide 5 text}}{{Slide 5 button text}}' + '</div>' + '</li>',
				section: 'Slide 5'
			},
			'Slide 5 title': {
				type: 'text',
			...
			'Text Shadow position': {
				type: 'select',
				options: [{ value: 'calc( -3px + -.07em ) calc( 2px + .03em )', label: 'Far Left' }, { value: 'calc( -1px + -.03em ) calc( 1px + .01em )', label: 'Left' }, { value: '0 0', label: 'Center' }, { value: 'calc( 1px + .03em ) calc( 1px + .01em )', label: 'Right' }, { value: 'calc( 2px + .05em ) calc( 2px + .03em )', label: 'Far Right' }],
				default: '0 0',
				section: 'Text Glow/Shadow'
			},
			'Text Shadow strength': {
				type: 'select',
				options: [{ value: '.25', label: 'Light' }, { value: '.5', label: 'Normal' }, { value: '.75', label: 'Strong' }],
				default: '.5',
				section: 'Text Glow/Shadow'
			}
		}
	...
	CaxtonBlock({
		...
		fields: {
			...
			'Gradient type': {
				type: 'select',
				options: [{ value: 'linear-gradient( ', label: 'Linear vertical' }, { value: 'linear-gradient( 90deg, ', label: 'Linear horizontal' }, { value: 'linear-gradient( 45deg, ', label: 'Linear 45 deg' }, { value: 'linear-gradient( -45deg, ', label: 'Linear 45 deg anticlockwise' }, { value: 'radial-gradient( ', label: 'Radial gradient' }],
			...
			'Column gap': {
				type: 'select',
				options: [{ value: 'grid-gap-none', label: 'None' }, { value: 'grid-gap-tight', label: 'Tight' }, { value: '', label: 'Normal' }, { value: 'grid-gap-wide', label: 'Wide' }, { value: 'grid-gap-wider', label: 'Wider' }],
				section: 'Layout'
			},
			'Inner Padding top': {
				type: 'range',
			...
			'Inner Padding unit': {
				type: 'select',
				options: [{ value: '%', label: 'Responsive' }, { value: 'px', label: 'Pixels x 5' }],
				default: '%',
				section: 'Layout'
			}
		},
		edit: function edit(props, block) {
			...
			var padB = void 0;
			var padR = void 0;
			var colCls = 'relative caxton-columns';
			var padMob = block.attrs['Inner Padding left/right tablet'];
			var padTab = block.attrs['Inner Padding left/right mobile'];
	...
	var CaxtonPostsGridEditComponent = function (_React$Component) {
		_inherits(CaxtonPostsGridEditComponent, _React$Component);

		function CaxtonPostsGridEditComponent(props) {
			_classCallCheck(this, CaxtonPostsGridEditComponent);

			var _this = _possibleConstructorReturn(this, (CaxtonPostsGridEditComponent.__proto__ || Object.getPrototypeOf(CaxtonPostsGridEditComponent)).apply(this, arguments));
		...
		_createClass(CaxtonPostsGridEditComponent, [{
			key: 'fetchUrls',
			value: function fetchUrls() {
				...
				var order = attrs.order.split('/');

				var url = '/caxton/v1/posts?posts_per_page=' + attrs.rows * attrs.columns + '&post__not_in=' + caxton.post + '&cat=' + attrs.cat + (attrs.postIDs ? '&post__in=' + attrs.postIDs : '') + (attrs.displayPostWithoutImages ? '&meta_key=' : '') + '&orderby=' + order[0] + '&order=' + order[1];
			...
			value: function render() {
				...
				var post = void 0;
				var gridInfo = void 0;
				var commentIcon = '<span class="fa fa-comments"></span>';
				var authorIcon = '<span class="fa fa-user-circle-o"></span>';
				var grids = [];
				var selected = props.isSelected;
				var className = props.className + ' ' + props.name.replace('/', '-') + ' caxton-grid';
				...
				if (!props.posts.data) {
					...
					for (var i = 0; i < props.posts.data.length; i++) {
						var postMetaMarkup = function postMetaMarkup() {
						...
						;
						gridInfo = [el('a', { className: 'grid-link', href: '#', key: 'anchor' }, el('div', { className: 'grid-image', style: { backgroundImage: 'url(' + post.thumb_ml + ')' } }, el('h3', { className: 'grid-title', style: { fontSize: attrs.titleSize } }, post.title)))];
				...
				return [!!selected && el(InspectorControls, { key: 'inspector' }, el(SelectControl, {
					label: 'Category',
					value: attrs.cat,
					...
					label: 'Order',
					value: attrs.order,
					options: [{ label: __('Newest to Oldest'), value: 'date/desc' }, { label: __('Oldest to Newest'), value: 'date/asc' }, { label: __('A → Z'), value: 'title/asc' }, { label: __('Z → A'), value: 'title/desc' }],
					onChange: function onChange(val) {
					...
					options: [{ label: __('Square'), value: '' }, { label: __('Circle'), value: 'circle' }, { label: __('Rectangle'), value: 'rectangle' }],
					onChange: function onChange(val) {
		...
		return CaxtonPostsGridEditComponent;
	}(React.Component);

	wp.blocks.registerBlockType('caxton/posts-grid', {
		title: 'Posts grid',
		icon: 'screenoptions',
		category: 'caxton',
