...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.CaxtonLayoutBlocksSetup=void 0;var _fields=require("./fields.es6"),_grid=require("./grid.es6"),_section=require("./section.es6"),_flex=require("./flex.es6"),_tpl=require("./tpl.es6");function _typeof(e){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}var CaxtonLayoutBlocksSetup=function(e,t){var n=t.element,o=caxtonWPEditor,r=n.createElement;_fields.gridFields["Mobile layout"].render=_grid.responsiveLayoutPicker,_fields.gridFields["Tablet layout"].render=_grid.responsiveLayoutPicker,CaxtonBlock({id:"caxton/grid",title:"Caxton Layouts",icon:"screenoptions",category:"caxton",fields:_fields.gridFields,attributes:{tpl:{type:"string"}},edit:function(e,t){return(0,_grid.gridRender)(e,t,(0,_grid.gridContent)(e,t))},save:function(e,t){return(0,_grid.gridRender)(e,t,r(o.InnerBlocks.Content,{key:"innerblockscontent"}))}}),CaxtonBlock({id:"caxton/section",title:"Caxton section",icon:"screenoptions",parent:["caxton/grid"],category:"caxton",attributes:{tpl:{type:"string"}},fields:_fields.sectionFields,edit:function(e,t){var n=[];e.attributes.tpl&&0===e.attributes.tpl.indexOf("[")&&e.attributes.tpl.indexOf("]")>0&&(n=JSON.parse(e.attributes.tpl));var o=r(caxtonWPEditor.InnerBlocks,{template:n,templateLock:!1,key:"innerblocks"});return(0,_section.sectionRender)(e,t,o)},save:function(e,t){return(0,_section.sectionRender)(e,t,[r(o.InnerBlocks.Content,{key:"innerblockscontent"})])},wrapperProps:function(e,t){return e["data-caxton-section"]=t["Grid area"],e.style={},e.style.gridArea=t["Grid area"],e}}),CaxtonBlock({id:"caxton/horizontal",title:"Horizontal blocks (deprecated)",icon:"text",category:"caxton",fields:_fields.flexFields,edit:function(e,t){return(0,_flex.flexRender)(e,t,[r(o.InnerBlocks,{key:"innerblocks",templateLock:!1})])},save:function(e,t){return(0,_flex.flexRender)(e,t,[r(o.InnerBlocks.Content,{key:"innerblockscontent"})])}}),CaxtonBlock({id:"caxton/flex",title:"Flex blocks (beta)",icon:"text",category:"caxton",fields:_fields.flexFields,edit:function(e,t){return(0,_flex.flexRender)(e,t,[r(o.InnerBlocks,{key:"innerblocks",templateLock:!1})])},save:function(e,t){return(0,_flex.flexRender)(e,t,[r(o.InnerBlocks.Content,{key:"innerblockscontent"})])},transforms:{from:[{type:"caxton/horizontal"}]}}),window.CaxtonLayoutOptionsBlock=function(e,t){e.id&&e.title||console.error("Function CaxtonLayoutOptionsBlock requires `id` and `title` properties on first parameter object."),e.debug&&(_fields.tplFields.tpl={type:"textarea",section:"Layout"});var n={icon:"screenoptions",category:"caxton",fields:_fields.tplFields,attributes:{tpl:{type:"string"}},chooseLayoutTitle:"Please choose a layout",optionsRenderer:function(e,n){for(var o=function(t){var n=jQuery(t.target).closest(".caxton-layout-option").data("props");"string"==typeof n&&(n=JSON.parse(n)),"object"===_typeof(n.tpl)&&(n.tpl=JSON.stringify(n.tpl)),e.setAttributes(n)},i=[],l=0;l<t.length;l++){var s=t[l];i.push(r("div",{className:"caxton-layout-option",key:"option-"+l,"data-props":JSON.stringify(s.props),onClick:o},r("img",{src:s.img}),r("h5",{},s.title)))}return r("div",{},[r("h4",{key:"heading"},"Select an layout"),r("div",{key:"options",className:"caxton-layout-options"},i)])},edit:function(e,t){return(0,_tpl.tplRender)(e,t,(0,_tpl.tplContent)(e,t,n.optionsRenderer))},save:function(e,t){return(0,_tpl.tplRender)(e,t,r(o.InnerBlocks.Content,{key:"innerblockscontent"}))}};for(var i in e)n[i]=e[i];CaxtonBlock(n)}};exports.CaxtonLayoutBlocksSetup=CaxtonLayoutBlocksSetup;
