...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.sectionRender=void 0;var sectionRender=function(a,e,t){var r,d,i,n,o,s=wp.element.createElement,l="relative caxton-section-block",g=e.attrs["Inner Padding left/right tablet"],c=e.attrs["Inner Padding left/right mobile"];r=e.attrs["Inner Padding unit"],d=e.attrs["Inner Padding top"],i=e.attrs["Inner Padding left"],n=e.attrs["Inner Padding bottom"],o=e.attrs["Inner Padding right"],"px"===r&&(d*=5,i*=5,n*=5,o*=5),d=d?d+r:0,i=i?i+r:0,n=n?n+r:0,o=o?o+r:0,e.attrs["Column gap"]&&(l+=" "+e.attrs["Column gap"]);a={className:"relative",key:"caxton-section-block",style:{gridArea:e.attrs["Grid area"]},"data-mobile-css":"grid-area:"+e.attrs["Mobile grid area"]+";","data-tablet-css":"grid-area:"+e.attrs["Tablet grid area"]+";"};var b=e.attrs["Mobile grid area"],u=e.attrs["Tablet grid area"];return b&&(a["data-mobile-css"]="grid-area:"+b+";"),u&&(a["data-tablet-css"]="grid-area:"+u+";"),s("div",a,[s("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML('<div class="cover bg-center absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background image}}{{Background image position}}{{Background parallax}}"></div><div class="absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background colors opacity}}"></div>')}),s("div",{className:l,style:{paddingTop:d,paddingLeft:i,paddingBottom:n,paddingRight:o},"data-mobile-css":"padding-left:"+g+"em;padding-right:"+g+"em;","data-tablet-css":"padding-left:"+c+"em;padding-right:"+c+"em;",key:"block"},t)])};exports.sectionRender=sectionRender;
