...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.listingFields=exports.sectionFields=exports.gridFields=void 0;var gridFields={"Background image":{type:"image",section:"Background",tpl:"background-image:url(%s);"},"Background image position":{type:"position",section:"Background",tpl:"background-position:%s;"},"Background parallax":{type:"toggle",value:"background-attachment:fixed;",section:"Background"},"Background color":{type:"color",section:"Background"},"Gradient color":{type:"color",section:"Background",tpl:", %s"},"Gradient type":{type:"select",options:[{value:"linear-gradient( ",label:"Linear vertical"},{value:"linear-gradient( 90deg, ",label:"Linear horizontal"},{value:"linear-gradient( 45deg, ",label:"Linear 45 deg"},{value:"linear-gradient( -45deg, ",label:"Linear 45 deg anticlockwise"},{value:"radial-gradient( ",label:"Radial gradient"}],default:"linear-gradient( ",section:"Background",tpl:"background-image:%s{{Background color}}{{Gradient color}});"},"Background colors opacity":{type:"range",min:0,max:1,step:.05,help:"Reduce opacity to have transparent colors over image",default:"1",section:"Background",tpl:"opacity:%s;"},Layout:{type:"select",options:[{value:"",label:"Normal"},{value:"vw-100-bg",label:"Full width background"},{value:"vw-100",label:"Full width content"}],section:"Layout"},"Column gap":{type:"select",options:[{value:"grid-gap-none",label:"None"},{value:"grid-gap-tight",label:"Tight"},{value:"",label:"Normal"},{value:"grid-gap-wide",label:"Wide"},{value:"grid-gap-wider",label:"Wider"}],section:"Layout"},"Inner Padding top":{type:"range",section:"Layout"},"Inner Padding left":{type:"range",max:70,section:"Layout"},"Inner Padding bottom":{type:"range",section:"Layout"},"Inner Padding right":{type:"range",max:70,section:"Layout"},"Inner Padding left/right tablet":{type:"range",max:70,section:"Layout"},"Inner Padding left/right mobile":{type:"range",max:70,section:"Layout"},"Inner Padding unit":{type:"select",options:[{value:"vw",label:"Responsive"},{value:"px",label:"Pixels x 5"}],default:"px",section:"Layout"},"Mobile layout":{type:"select",section:"Responsive layout",childField:"Mobile grid area"},"Tablet layout":{type:"select",section:"Responsive layout",childField:"Tablet grid area"}};exports.gridFields=gridFields;var sectionFields={"Inner Padding top":{type:"range",section:"Layout",default:1},"Inner Padding bottom":{type:"range",section:"Layout",default:1},"Inner Padding left":{type:"range",max:50,section:"Layout",default:1},"Inner Padding right":{type:"range",max:50,section:"Layout",default:1},"Inner Padding left/right tablet":{type:"range",max:50,section:"Layout",default:1},"Inner Padding left/right mobile":{type:"range",max:50,section:"Layout",default:1},"Inner Padding unit":{type:"select",options:[{value:"vw",label:"Responsive"},{value:"px",label:"Pixels x 5"}],default:"px",section:"Layout"},"Background image":{type:"image",section:"Background",tpl:"background-image:url(%s);"},"Background image position":{type:"position",section:"Background",tpl:"background-position:%s;"},"Background parallax":{type:"toggle",value:"background-attachment:fixed;",section:"Background"},"Background color":{type:"color",section:"Background"},"Gradient color":{type:"color",section:"Background",tpl:", %s"},"Gradient type":{type:"select",options:[{value:"linear-gradient( ",label:"Linear vertical"},{value:"linear-gradient( 90deg, ",label:"Linear horizontal"},{value:"linear-gradient( 45deg, ",label:"Linear 45 deg"},{value:"linear-gradient( -45deg, ",label:"Linear 45 deg anticlockwise"},{value:"radial-gradient( ",label:"Radial gradient"}],default:"linear-gradient( ",section:"Background",tpl:"background-image:%s{{Background color}}{{Gradient color}});"},"Background colors opacity":{type:"range",min:0,max:1,step:.05,help:"Reduce opacity to have transparent colors over image",default:"1",section:"Background",tpl:"opacity:%s;"},"Grid area":{type:"text",description:"Change grid-area CSS property.",section:"Jedi controls",default:"span 1 / span 4 / auto / auto"},"Tablet grid area":{type:"text",description:"Change grid-area CSS property for Tablet devices.",section:"Jedi controls"},"Mobile grid area":{type:"text",description:"Change grid-area CSS property for Mobile devices.",section:"Jedi controls"}};exports.sectionFields=sectionFields;var listingFields={Alignment:{type:"select",section:"Layout",options:[{value:"flex-start",label:"Left"},{value:"center",label:"Center"},{value:"flex-end",label:"Right"},{value:"space-between",label:"Justify"}],default:1},"Vertical Alignment":{type:"select",section:"Layout",options:[{value:"flex-start",label:"Top"},{value:"center",label:"Center"},{value:"flex-end",label:"Bottom"}],default:1},"Inner Padding top":{type:"range",section:"Layout",default:1},"Inner Padding bottom":{type:"range",section:"Layout",default:1},"Inner Padding left":{type:"range",max:50,section:"Layout",default:1},"Inner Padding right":{type:"range",max:50,section:"Layout",default:1},"Inner Padding left/right tablet":{type:"range",max:50,section:"Layout",default:1},"Inner Padding left/right mobile":{type:"range",max:50,section:"Layout",default:1},"Inner Padding unit":{type:"select",options:[{value:"vw",label:"Responsive"},{value:"px",label:"Pixels x 5"}],default:"px",section:"Layout"},"Background image":{type:"image",section:"Background",tpl:"background-image:url(%s);"},"Background image position":{type:"position",section:"Background",tpl:"background-position:%s;"},"Background parallax":{type:"toggle",value:"background-attachment:fixed;",section:"Background"},"Background color":{type:"color",section:"Background"},"Gradient color":{type:"color",section:"Background",tpl:", %s"},"Gradient type":{type:"select",options:[{value:"linear-gradient( ",label:"Linear vertical"},{value:"linear-gradient( 90deg, ",label:"Linear horizontal"},{value:"linear-gradient( 45deg, ",label:"Linear 45 deg"},{value:"linear-gradient( -45deg, ",label:"Linear 45 deg anticlockwise"},{value:"radial-gradient( ",label:"Radial gradient"}],default:"linear-gradient( ",section:"Background",tpl:"background-image:%s{{Background color}}{{Gradient color}});"},"Background colors opacity":{type:"range",min:0,max:1,step:.05,help:"Reduce opacity to have transparent colors over image",default:"1",section:"Background",tpl:"opacity:%s;"},"Tablet Alignment":{type:"select",section:"Layout",options:[{value:"flex-start",label:"Left"},{value:"center",label:"Center"},{value:"flex-end",label:"Right"},{value:"space-between",label:"Justify"}],default:1},"Mobile Alignment":{type:"select",section:"Layout",options:[{value:"flex-start",label:"Left"},{value:"center",label:"Center"},{value:"flex-end",label:"Right"},{value:"space-between",label:"Justify"}],default:1}};exports.listingFields=listingFields;

},{}],4:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.gridRender=gridRender,exports.gridContent=gridContent,exports.responsiveLayoutPicker=responsiveLayoutPicker;var _layouts=_interopRequireDefault(require("./layouts.json")),_altLayouts=_interopRequireDefault(require("./alt-layouts.json"));function _interopRequireDefault(t){return t&&t.__esModule?t:{default:t}}function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function gridRender(t,e,a){var o,r,n,l,i,s=wp.element.createElement,u="relative ",c="relative caxton-columns caxton-grid-block",p=e.attrs["Inner Padding left/right tablet"],d=e.attrs["Inner Padding left/right mobile"];return o=e.attrs["Inner Padding unit"],r=e.attrs["Inner Padding top"],n=e.attrs["Inner Padding left"],l=e.attrs["Inner Padding bottom"],i=e.attrs["Inner Padding right"],"px"===o&&(r*=5,n*=5,l*=5,i*=5),r=r?r+o:0,n=n?n+o:0,l=l?l+o:0,i=i?i+o:0,e.attrs.Layout&&(u+=" "+e.attrs.Layout),e.attrs["Column gap"]&&(c+=" "+e.attrs["Column gap"]),e.attrs["Full height"]&&(c+=" "+e.attrs["Full height"]),'<div class="cover bg-center absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background image}}{{Background image position}}{{Background parallax}}"></div>','<div class="absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background colors opacity}}"></div>',s("div",{className:u,key:"caxton-grid-block"},s("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML('<div class="cover bg-center absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background image}}{{Background image position}}{{Background parallax}}"></div><div class="absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background colors opacity}}"></div>')}),s("div",{className:c,style:{paddingTop:r,paddingLeft:n,paddingBottom:l,paddingRight:i,gridTemplateColumns:"repeat(12, 1fr)"},"data-tablet-css":"padding-left:"+d+"em;padding-right:"+d+"em;","data-mobile-css":"padding-left:"+p+"em;padding-right:"+p+"em;",key:"block"},a))}function parseLayout(t){var e=0,a={attr:{},tpl:[],_numRows:0};if(t.tpl&&t.tpl.length){for(var o=0;o<t.tpl.length;o++){var r=t.tpl[o];if("object"===_typeof(r)&&r[1]&&r[0]&&(r[1],r=r[0]),"object"===_typeof(r))a.tpl.push(["caxton/section",r]);else if("string"==typeof r){if(/[0-9]{1,2},[0-9]{1,2}/.test(r)){var n=r.split(",");r="span "+n.join("/span "),e+=n[0]*n[1]}a.tpl.push(["caxton/section",{"Grid area":r}])}}return"object"===_typeof(t.attr)&&(a.attr=t.attr),t._numRows?a._numRows=t._numRows:e&&(a._numRows=Math.ceil(e/12)),a}}function layoutElement(t,e){e=e||0;for(var a=wp.element.createElement,o=[],r=0;r<t.tpl.length;r++){var n=t.tpl[r];o.push(a("div",{className:"caxton-layout-preview-section",key:"layout-section-"+r,style:{gridArea:n[1]["Grid area"]}}))}return a("div",{className:"caxton-layout-preview-wrap",key:"layout-wrap-"+e},a("div",{className:"caxton-layout-preview",key:"layout-"+e,"data-layout":JSON.stringify(t)},o))}function gridLayoutPicker(t){for(var e,a=[],o=[],r=wp.element.createElement,n=0;n<_layouts.default.length;n++){var l=parseLayout(_layouts.default[n]);o[e=l._numRows]||(o[e]=[]),o[e].push(layoutElement(l,n)),l.attr&&t.setAttributes(l.attr)}for(var i=0;i<o.length;i++)a.push(r("div",{className:"clear"},o[i]));return r("div",{className:"caxton-layout-picker",key:"caxton-layout-picker",onClick:function(e){var a=jQuery(e.target).closest(".caxton-layout-preview").data("layout");"string"==typeof a&&(a=JSON.parse(a)),"object"===_typeof(a.tpl)&&(a.tpl=JSON.stringify(a.tpl)),t.setAttributes(a)}},r("h3",{},"Please choose a layout..."),r("div",{},a))}function gridContent(t,e){var a=wp.element.createElement;if(t.attributes.tpl&&0===t.attributes.tpl.indexOf("[")&&t.attributes.tpl.indexOf("]")>0){var o=JSON.parse(t.attributes.tpl);return a(wp.editor.InnerBlocks,{allowedBlocks:["caxton/section"],template:o,templateLock:"all",key:"innerblocks"})}return gridLayoutPicker(t)}function responsiveLayoutElement(t,e,a){e=e||0;var o="span "+t.join("|span ").replace(/,/g,"/span "),r="caxton-layout-preview";o===a.value&&(r+=" caxton-layout-selected");for(var n=wp.element.createElement,l=[],i=0;i<t.length;i++){var s=t[i].split(",");l.push(n("div",{className:"caxton-layout-preview-section",key:"layout-section-"+i,style:{gridArea:"span "+s.join("/span ")}}))}return n("div",{className:"caxton-layout-preview-wrap",key:"layout-wrap-"+e},n("div",{className:r,key:"layout-"+e,"data-layout":o},l))}function responsiveLayoutPicker(t,e){t.title=t.label;var a=e.props,o=wp.element.createElement;if(!e.attrs.tpl)return o("div",{},"Please select a layout to get started.");var r=e.attrs.tpl?JSON.parse(e.attrs.tpl).length:0,n=[],l=_altLayouts.default[r+"-sections"];if(l&&l.length>1){for(var i=0;i<l.length;i++)n.push(responsiveLayoutElement(l[i],i,t));return o(wp.components.PanelBody,t,o("div",{className:"caxton-layout-picker caxton-responsive-layout-picker",onClick:function(e){var o=e.target,r=$(o).closest("[data-layout]");if(r.length){var n=r.data("layout");n=n?n.split("|"):[];var l=wp.data.select("core/editor").getBlocksByClientId(a.clientId)[0];if(l&&n)for(var i=l.innerBlocks,s=0;s<i.length;s++)n[s]&&(i[s].attributes[t.childField]=n[s]);t.onChange(r.data("layout"))}}},n,o("div",{className:"clear"})))}return o(wp.components.PanelBody,t,o("div",{},"No alternative layouts found."))}

},{"./alt-layouts.json":2,"./layouts.json":6}],5:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.CaxtonLayoutBlocksSetup=void 0;var _fields=require("./fields.es6"),_grid=require("./grid.es6"),_section=require("./section.es6"),_listing=require("./listing.es6"),CaxtonLayoutBlocksSetup=function(e,n){var t=n.element,i=n.editor,o=t.createElement;_fields.gridFields["Mobile layout"].render=_grid.responsiveLayoutPicker,_fields.gridFields["Tablet layout"].render=_grid.responsiveLayoutPicker,CaxtonBlock({id:"caxton/grid",title:"Caxton Layouts",icon:"screenoptions",category:"caxton",fields:_fields.gridFields,attributes:{tpl:{type:"string"}},edit:function(e,n){return(0,_grid.gridRender)(e,n,(0,_grid.gridContent)(e,n))},save:function(e,n){return(0,_grid.gridRender)(e,n,o(i.InnerBlocks.Content,{key:"innerblockscontent"}))}}),CaxtonBlock({id:"caxton/section",title:"Caxton section",icon:"screenoptions",parent:["caxton/grid"],category:"caxton",fields:_fields.sectionFields,edit:function(e,n){return(0,_section.sectionRender)(e,n,[o(i.InnerBlocks,{key:"innerblocks",templateLock:!1})])},save:function(e,n){return(0,_section.sectionRender)(e,n,[o(i.InnerBlocks.Content,{key:"innerblockscontent"})])},wrapperProps:function(e,n){return e["data-caxton-section"]=n["Grid area"],e.style={},e.style.gridArea=n["Grid area"],e}}),CaxtonBlock({id:"caxton/listing",title:"Caxton listing",icon:"text",category:"caxton",fields:_fields.listingFields,edit:function(e,n){return(0,_listing.listingRender)(e,n,[o(i.InnerBlocks,{key:"innerblocks",templateLock:!1})])},save:function(e,n){return(0,_listing.listingRender)(e,n,[o(i.InnerBlocks.Content,{key:"innerblockscontent"})])}}),CaxtonBlock({id:"caxton/link-item",title:"Caxton link item",icon:"text",category:"caxton",fields:_fields.listingFields,edit:function(e,n){return(0,_listing.listingRender)(e,n,[o(i.InnerBlocks,{key:"innerblocks",templateLock:!1})])},save:function(e,n){return(0,_listing.listingRender)(e,n,[o(i.InnerBlocks.Content,{key:"innerblockscontent"})])}})};exports.CaxtonLayoutBlocksSetup=CaxtonLayoutBlocksSetup;

},{"./fields.es6":3,"./grid.es6":4,"./listing.es6":7,"./section.es6":8}],6:[function(require,module,exports){
module.exports=[
	{
		"tpl": [
			{
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.listingRender=void 0;var listingRender=function(t,e,a){var n,i,s,l,r,d=wp.element.createElement,o="relative caxton-listing-block",g=e.attrs["Inner Padding left/right tablet"],c=e.attrs["Inner Padding left/right mobile"];n=e.attrs["Inner Padding unit"],i=e.attrs["Inner Padding top"],s=e.attrs["Inner Padding left"],l=e.attrs["Inner Padding bottom"],r=e.attrs["Inner Padding right"],"px"===n&&(i*=5,s*=5,l*=5,r*=5),i=i?i+n:0,s=s?s+n:0,l=l?l+n:0,r=r?r+n:0,e.attrs["Column gap"]&&(o+=" "+e.attrs["Column gap"]);var u={className:"relative",key:"caxton-section-block",style:{"justify-content":e.attrs.Alignment,"align-items":e.attrs["Vertical Alignment"]}};return e.attrs["Mobile Alignment"]&&(u["data-mobile-css"]="justify-content:"+e.attrs["Mobile Alignment"]+";",u["data-desktop-css"]="justify-content:"+e.attrs.Alignment+";"),e.attrs["Tablet Alignment"]&&(u["data-tablet-css"]="justify-content:"+e.attrs["Tablet Alignment"]+";",u["data-desktop-css"]="justify-content:"+e.attrs.Alignment+";"),d("div",u,[d("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML('<div class="cover bg-center absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background image}}{{Background image position}}{{Background parallax}}"></div><div class="absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background colors opacity}}"></div>')}),d("div",{className:o,style:{paddingTop:i,paddingLeft:s,paddingBottom:l,paddingRight:r},"data-mobile-css":"padding-left:"+g+"em;padding-right:"+g+"em;","data-tablet-css":"padding-left:"+c+"em;padding-right:"+c+"em;",key:"block"},a)])};exports.listingRender=listingRender;

},{}],8:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.sectionRender=void 0;var sectionRender=function(a,t,e){var r,d,i,s,n,o=wp.element.createElement,l="relative caxton-section-block",g=t.attrs["Inner Padding left/right tablet"],c=t.attrs["Inner Padding left/right mobile"];r=t.attrs["Inner Padding unit"],d=t.attrs["Inner Padding top"],i=t.attrs["Inner Padding left"],s=t.attrs["Inner Padding bottom"],n=t.attrs["Inner Padding right"],"px"===r&&(d*=5,i*=5,s*=5,n*=5),d=d?d+r:0,i=i?i+r:0,s=s?s+r:0,n=n?n+r:0,t.attrs["Column gap"]&&(l+=" "+t.attrs["Column gap"]);var b={className:"relative",key:"caxton-section-block",style:{gridArea:t.attrs["Grid area"]}};t.attrs["Mobile grid area"],t.attrs["Tablet grid area"];return t.attrs["Mobile grid area"]&&(b["data-mobile-css"]="grid-area:"+t.attrs["Mobile grid area"]+";",b["data-desktop-css"]="grid-area:"+t.attrs["Grid area"]+";"),t.attrs["Tablet grid area"]&&(b["data-tablet-css"]="grid-area:"+t.attrs["Tablet grid area"]+";",b["data-desktop-css"]="grid-area:"+t.attrs["Grid area"]+";"),o("div",b,[o("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:t.outputHTML('<div class="cover bg-center absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background image}}{{Background image position}}{{Background parallax}}"></div><div class="absolute absolute--fill" style="background-color:{{Background color}};{{Gradient type}}{{Background colors opacity}}"></div>')}),o("div",{className:l,style:{paddingTop:d,paddingLeft:i,paddingBottom:s,paddingRight:n},"data-mobile-css":"padding-left:"+g+"em;padding-right:"+g+"em;","data-tablet-css":"padding-left:"+c+"em;padding-right:"+c+"em;",key:"block"},e)])};exports.sectionRender=sectionRender;
