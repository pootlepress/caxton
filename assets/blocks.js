...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.flexRender=void 0;var flexRender=function(t,e,n){var a,i,s,r,l,d=wp.element.createElement,o={className:"relative caxton-flex-block","data-mobile-css":"","data-tablet-css":"",key:"block"},g=e.attrs["Inner Padding left/right tablet"],m=e.attrs["Inner Padding left/right mobile"];return"caxon/horizontal"===e.name&&(o.className="relative caxton-listing-block"),a=e.attrs["Inner Padding unit"],i=e.attrs["Inner Padding top"],s=e.attrs["Inner Padding left"],r=e.attrs["Inner Padding bottom"],l=e.attrs["Inner Padding right"],"px"===a&&(i*=5,s*=5,r*=5,l*=5),i=i?i+a:0,s=s?s+a:0,r=r?r+a:0,l=l?l+a:0,o.style={paddingTop:i,paddingLeft:s,paddingBottom:r,paddingRight:l,"justify-content":e.attrs.Alignment,"min-height":e.attrs["Minimum content height"],"align-items":e.attrs.Alignment},o["data-desktop-css"]="padding-left:"+s+"em;padding-right:"+l+"em;",o["data-mobile-css"]="padding-left:"+g+"em;padding-right:"+g+"em;",o["data-tablet-css"]="padding-left:"+m+"em;padding-right:"+m+"em;",e.attrs["Column gap"]&&(o.className+=" "+e.attrs["Column gap"]),"px"===e.attrs["Content height unit"]?o.style["min-height"]=10*o.style["min-height"]+"px":o.style["min-height"]=o.style["min-height"]+e.attrs["Content height unit"],e.attrs["Content direction"]&&(o.style["flex-direction"]=e.attrs["Content direction"]),e.attrs["Items margin"]&&(o.style["--caxton-gap"]=e.attrs["Items margin"]+"px"),e.attrs["Content justify"]&&(o.style["justify-content"]=e.attrs["Content justify"]),e.attrs["Mobile Alignment"]&&(o["data-mobile-css"]+="justify-content:"+e.attrs["Mobile Alignment"]+";",o["data-desktop-css"]+="justify-content:"+e.attrs["Content justify"]+";"),e.attrs["Tablet Alignment"]&&(o["data-tablet-css"]+="justify-content:"+e.attrs["Tablet Alignment"]+";",o["data-desktop-css"]+="justify-content:"+e.attrs["Content justify"]+";"),d("div",{className:"relative",key:"caxton-flex-block-wrap"},[d("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML("{{Background}}")}),d("div",o,n)])};exports.flexRender=flexRender;
