...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.flexRender=void 0;var flexRender=function(t,e,n){var a,i,s,r,l,o=wp.element.createElement,d="relative caxton-flex-block",g=e.attrs["Inner Padding left/right tablet"],c=e.attrs["Inner Padding left/right mobile"];"caxon/horizontal"===e.name&&(d="relative caxton-listing-block"),a=e.attrs["Inner Padding unit"],i=e.attrs["Inner Padding top"],s=e.attrs["Inner Padding left"],r=e.attrs["Inner Padding bottom"],l=e.attrs["Inner Padding right"],"px"===a&&(i*=5,s*=5,r*=5,l*=5),i=i?i+a:0,s=s?s+a:0,r=r?r+a:0,l=l?l+a:0,e.attrs["Column gap"]&&(d+=" "+e.attrs["Column gap"]);var m={className:"relative",key:"caxton-section-block",style:{"justify-content":e.attrs.Alignment,"min-height":e.attrs["Minimum content height"],"align-items":e.attrs["Vertical Alignment"]}};return"px"===e.attrs["Content height unit"]?m.style["min-height"]=10*m.style["min-height"]+"px":m.style["min-height"]=m.style["min-height"]+e.attrs["Content height unit"],e.attrs["Content direction"]&&(m.style["flex-direction"]=e.attrs["Content direction"]),e.attrs["Content justify"]&&(m.style["justify-content"]=e.attrs["Content justify"]),e.attrs["Mobile Alignment"]&&(m["data-mobile-css"]="justify-content:"+e.attrs["Mobile Alignment"]+";",m["data-desktop-css"]="justify-content:"+e.attrs["Content justify"]+";"),e.attrs["Tablet Alignment"]&&(m["data-tablet-css"]="justify-content:"+e.attrs["Tablet Alignment"]+";",m["data-desktop-css"]="justify-content:"+e.attrs["Content justify"]+";"),o("div",m,[o("div",{key:"bg",className:"absolute absolute--fill",dangerouslySetInnerHTML:e.outputHTML("{{Background}}")}),o("div",{className:d,style:{paddingTop:i,paddingLeft:s,paddingBottom:r,paddingRight:l},"data-mobile-css":"padding-left:"+g+"em;padding-right:"+g+"em;","data-tablet-css":"padding-left:"+c+"em;padding-right:"+c+"em;",key:"block"},n)])};exports.flexRender=flexRender;
